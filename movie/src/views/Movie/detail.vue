  ...
  <div id="detailContrainer" class="slide-enter-active">
    ...
    <div v-else id="content" class="contentDetail">
        <div class="detail_list">
					<div class="detail_list_bg" style="background-image: url(&quot;http://p0.meituan.net/148.208/movie/71fba05fbe4912cb70d27b87c3c856393364925.jpg&quot;);"></div>
        ...
        <div class="detail_player" ref="detail_player">
					<ul class="swiper-wrapper">
						<li class="swiper-slide swiper-slide-active" v-for="(item,index) in detailMovie.photos" :key="index">
								<div>
...
.detail_player .swiper-slide p[data-v-7f6c6266]:nth-of-type(2) {
	color: #999
}
</style>
